// ai0 entitlements — canonical source: browser-based-tools/MONETIZATION.md. Copy, don't drift.
// Offline license verification. No network calls, ever. DORMANT: nothing in ai0 imports
...
const HUB = 'ai0'; // ← per hub: ai0 | media0 | privacy0 | dev0 | web0 | data0
